...
class Scratch3RpiPython {
    ...
    messageSendDisplay (args) {
        ...
        if (connected) {
            ...
            const callbackEntry = [this.messageSendDisplay.bind(this), args];
    ...
    messageSendLoRa (args) {
        ...
        if (connected) {
            ...
            const callbackEntry = [this.messageSendLoRa.bind(this), args];
            wait_open.push(callbackEntry);
        }
    }
